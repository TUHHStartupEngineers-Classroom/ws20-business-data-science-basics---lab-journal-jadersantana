...
#combined_assignee_patent_assignee_tbl %>% glimpse()

#setkey(combined_assignee_patent_assignee_tbl, "id")
#key(combined_assignee_patent_assignee_tbl)

#?setorder()
#setorderv(combined_assignee_patent_assignee_tbl, c("id"))
